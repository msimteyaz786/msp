        ...
        for(i=0; i<localStorage.length; i++)
            {
                ...
                if(all_keys.match(sessionStorage.getItem("user")+"_contact"))
                {
                    ...
                    name_p.style.fontWeight="bold";


                    var name_i = document.createElement("I");
                    name_i.setAttribute("class","fas fa-caret-down");
                    ...
                    num_i.setAttribute("class","fas fa-hand-point-right");
    ...
    function del()
        ...
        for(i=0; i<del.length; i++)
        {
            del[i].onclick = function()
            {
                ...
                var username = p_ele.innerHTML.replace('<i class="fas fa-caret-down"></i>','');
...
function edit()
{
    ...
    for(i=0; i<edit_icon.length; i++)
    {
        edit_icon[i].onclick = function()
        {
            ...
            var name = para[0].innerHTML.replace('<i class="fas fa-caret-down"></i>',"").trim();
            var number = para[1].innerHTML.replace('<i class="fas fa-hand-point-right"></i>',"").trim();
            var c_name = document.getElementById("c_name");
            var c_num = document.getElementById("c_num");
